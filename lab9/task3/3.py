...
buttons = [
    {"rect": pygame.Rect(2, 2, 21, 21), "image": pygame.transform.scale(pygame.image.load("paint-brush_13329107.png"), (21, 21))},
    {"rect": pygame.Rect(2, 27, 21, 21), "image": pygame.transform.scale(pygame.image.load("eraser_9363850.png"), (21, 21))},
    {"rect": pygame.Rect(2, 52, 21, 21), "image": pygame.transform.scale(pygame.image.load("eraser_9363850.png"), (21, 21))},
    {"rect": pygame.Rect(2, 77, 21, 21), "image": pygame.transform.scale(pygame.image.load("color-illustrator_401085.png"), (21, 21))}
]
active_index = None
...
buttonsfor2 = [
    {"icon": pygame.transform.scale(pygame.image.load("delta_13315026.png"), (21, 21)), "rect": pygame.Rect(27, 52, 21 ,21)},
    {"icon": pygame.transform.scale(pygame.image.load("vecteezy_black-rectangle-isolated_42730310.png"), (21, 21)), "rect": pygame.Rect(52, 52, 21 ,21)},
    {"icon": pygame.transform.scale(pygame.image.load("vecteezy_colored-grunge-circle-brush-ink-frame_21975741.png"), (21, 21)), "rect": pygame.Rect(77, 52, 21 ,21)},
    {"icon": pygame.transform.scale(pygame.image.load("rhombus.png"), (21, 21)), "rect": pygame.Rect(27, 75, 21 ,21)},
    {"icon": pygame.transform.scale(pygame.image.load("geometry_12770115.png"), (21, 21)), "rect": pygame.Rect(52, 75, 21 ,21)},
    {"icon": pygame.transform.scale(pygame.image.load("stop_13570129.png"), (21, 21)), "rect": pygame.Rect(77, 75, 21 ,21)}
]
